...
import 'resources/features/complaints/presentation/state/bloc/complaints_bloc.dart';
import 'resources/features/complaints/presentation/state/cubit/image_counter_cubit.dart';
        ...
        providers: [
          ...
          BlocProvider<ComplaintsBloc>(
            create: (BuildContext context) =>
                ComplaintsBloc()..add(SerializationEvent()),
          ),
        ],
        child: MyApp(),
      ),
            ...
            return MaterialApp.router(
              ...
              routerConfig: appRouter.config(
                deepLinkBuilder: (deepLink) {
                  if (deepLink.path
                      .startsWith('/app/complaintsNavigator/details/')) {
